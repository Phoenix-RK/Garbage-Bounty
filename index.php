...
<a class="nav-link" data-value="products" href="#products">Products</a>
<a href="about.html">About Us</a>
<a href="#contact" data-value="contact">Contact Us</a>
<!<a href="faq.html"AQs</a>
<a href="register_Copy.php" > Register</a>
<a href="login.php"> Log In </a>
<a href="deliverer_login.php"> Deliverer Login </a>
</div>
...
<div class="mySlides fade" style="text-align:center">
  ...
  <div class="text1" style="text-align:center"><a href="login.php" class="button">Paper-Exchange for one of our products!</a></div>
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="clothes.jpg" style="width:100%" align="center">
  <div class="text1" style="text-align:center"><a href="login.php" class="button">Clothes-Exchange for one of our products!</a></div>
</div>

<div class="mySlides fade">
 <div class="numbertext">3 / 3</div>
  <img src="cardboard.jpg" style="width:100%" align="center">
  <div class="text1" style="text-align:center"><a href="login.php" class="button">Cardboard-Exchange for one of our products!</a></div>
</div>
...
<a href="login.php"><div class="container" style="text-align: center">
...
<a href="login.php"><div class="container">
...
<a href="login.php">
<div class="container">
  <img src="cloth purse.jpg" alt="Purse" class="image" href="clothMaterials.php" >
  <div class="overlay">
...
<br>
 ...
 <!-- Subscribe section -->
  <div class="w3-container w3-orange w3-padding-32" id="contact">
  ...
  <footer class="w3-padding-64 w3-light-grey w3-small w3-center" id="footer">
    <div class="w3-row-padding">
      <div class="w3-col s4 contactpage">
        <h4>Contact</h4>
      ...
      <div class="w3-col s4 w3-justify store" >
        <h4>Store</h4>
